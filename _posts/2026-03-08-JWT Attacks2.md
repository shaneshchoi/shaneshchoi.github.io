...
Lab: [**JWT authentication bypass via jku header injection**]({% post_url 2026-03-10-jku header injection-Lab %})
...
Lab: [**JWT authentication bypass via kid header path traversal**]({% post_url 2026-03-10-kid header path traversal-Lab %})
